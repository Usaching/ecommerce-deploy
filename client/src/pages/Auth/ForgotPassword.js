      ...
      <div className='form-container'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="form-control" id="exampleInputPassword1" placeholder='Enter password' required/>
                </div>
