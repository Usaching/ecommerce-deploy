...
const UpdateProduct = () => {
    ...
    //if dont want to use formdata than wrap all input and select tag tags within form tag and add handle create funtion on form onSubmit event
    const handleUpdate = (e) =>{
        ...
        try{
            ...
            //data?.message optional chaining or data && data.message
            if(data?.success) {
